...
const financial = [
    { "descricao": "Curso Automacao", "valor": 152.22, "mes": "Novembro" },
    { "descricao": "Curso Automacao API", "valor": 152.22, "mes": "Novembro" },
    { "descricao": "Curso Automacao WEB", "valor": 152.22, "mes": "Novembro" }
]
...
financial.forEach(element => {
    describe('Popular banco', () => {
        ...
        it('Salvar dados de receitas', (done) => {
            request
...
describe('Evitar dados duplicados para o mesmo mês', () => {
    ...
    it('Sistema deve exibir mensagem de duplicidade', (done) => {
        request
            .put(getEnvString('FINANCIAL_INCOME') + id_financial)
            .send(financial[0])
            .end((err, res) => {
